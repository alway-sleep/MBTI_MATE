...
public class CommentsPageMaker {
	private CommentsPageCriteria commentsPageCriteria;
	...
	public CommentsPageMaker() {
		this.numsOfPageLinks = 5;
	}
	
	public CommentsPageCriteria getCommentsPageCriteria() {
		return commentsPageCriteria;
	}
	
	public void setCriteria(CommentsPageCriteria commentsPageCriteria) {
		this.commentsPageCriteria = commentsPageCriteria;
	}
	...
	public void setPageData() {
		totalLinkNo = (int) Math.ceil((double) totalCount / commentsPageCriteria.getNumsPerPage());
		int temp = (int) Math.ceil((double) commentsPageCriteria.getPage() / numsOfPageLinks) * numsOfPageLinks;
