...
.selectId-wrapper form {
	display: flex;
	flex-direction: column;
}

.selectId-wrapper input[type="text"] {
	padding: 8px;
	border-radius: 3px;
...
.selectId-wrapper input[placeholder] {
	font-weight: bold;
}
/* 주민등록번호 스타일 */
.selectId-wrapper .memberRRN input[type=text]:nth-child(1) {
	text-align: center;
	width: 150px;
}

.selectId-wrapper .memberRRN input[type=text]:nth-child(3) {
	text-align: center;
	width: 50px;
}
/* 휴대폰 번호 스타일 */
.selectId-wrapper .memberPhone input[type="text"] {
	text-align: center;
	width: 94px;
}
/* sumit 버튼 스타일 */
.selectId-wrapper input[type="submit"] {
...
.selectId-wrapper input[type="submit"]:hover {
...
<body>
	<div class="selectId-wrapper">
		<div class="close"><button type="button" onclick="window.close()">&times;</button></div>
		<h2>아이디 찾기</h2>
		<form class="selectId-form" action="/mbti/member/selectId" method="post">
